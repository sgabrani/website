        ...
        internship: {
            ...
            <>
                ...
                <ul>
                    ...
                    <li> Moonshots handles bold, new initiatives for ACM to take on; past examples include <Link href="/impact"><span>Impact</span></Link> and <Link href="/jedi"><span>JEDI</span></Link>! </li>
                </ul>
            </> ),
            whatInternsWillDo: (
            <ul>
